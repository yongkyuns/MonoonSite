...
const description = 'Software for understanding complex systems. MonoonAI develops sensor fusion, controls, simulation, and visualization tools, grounded in automotive and embedded engineering.';
